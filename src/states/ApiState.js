...
const apiData = {
    ...
    // prefixOptions: ["heart"],
    // Mapping between display names and actual prefix values
    prefixMapping: {
        "OB": "ob",
        "MOE": "moe",
    },
    // Generate prefixOptions from the keys of prefixMapping
    get prefixOptions() {
        return Object.keys(this.prefixMapping);
    },
    

    // prefix: params.has("prefix") ? params.get("prefix") : "heart",
    prefix: params.has("prefix") ? params.get("prefix") : "ob",
    pallete: {},
